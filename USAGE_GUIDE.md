...
bluebox recipe run pcap-overview [--case-path <case-path>]
bluebox recipe run evtx-overview [--case-path <case-path>]
bluebox recipe run metadata-scan [--case-path <case-path>]
bluebox recipe run strings-triage [--case-path <case-path>]
bluebox recipe run quick-yara-scan [--case-path <case-path>]
